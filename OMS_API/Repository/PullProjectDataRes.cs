...
namespace OMS_API.Repository
{
    ...
    {
        public IEnumerable<PullProjectData> GetAllData(int ProjectID, int SourceID, DateTime DateFrom, DateTime DateEnd)
        {
            try
            {
                ...
                var enumResult = DapperHelper.Query<PullProjectData>("oms_PullProjectData", "admin", param);
                return enumResult;
            }
            catch (Exception ex)
            {
